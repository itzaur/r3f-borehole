    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            Бурение производится малогабаритной гидробуровой установкой без
            заезда крупногабаритной спецтехники на Ваш участок.
          </p>
        </section>
        ...
        >
          ...
          >
            ...
            <ul style={{ listStylePosition: 'inside' }}>
              ...
              <li>промывка скважины в случае уменьшения ее дебита;</li>
              <li>замена автоматики и гидроаккумулятора.</li>
            </ul>
          </div>
        </section>
